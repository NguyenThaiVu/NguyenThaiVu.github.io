...
[4. Simple Visualizations](#4simple-visualizations)
...
![](/Image/Interactive_debugging/interactive_debugging_tool_visualization.png){:width="100%"} 
...
dataFrame.head(10)
```
![](/Image/Tidy_data/dataFrame_head.png){:width="100%"} 
<!-- ![](/Image/Tidy_data/dataframe-1.png){:width="100%"}  -->
<!-- ![](/Image/Tidy_data/dataframe-2.png){:width="100%"}  -->
